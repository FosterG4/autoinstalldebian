...
echo "------"  | tee -a log-install.txt
echo "menu         (Show List Menu)"  | tee -a log-install.txt
echo "user-add     (Create SSH Account)"  | tee -a log-install.txt
echo "trial        (Create Trial SSH Account)"  | tee -a log-install.txt
echo "user-del     (Delete User)"  | tee -a log-install.txt
echo "user-login   (User Login Check)"  | tee -a log-install.txt
echo "user-list    (SSH Member Check)"  | tee -a log-install.txt
...
echo "info         (Show System Information)"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
...
echo "Foster"  | tee -a log-install.txt
echo "----"  | tee -a log-install.txt
echo "G4"  | tee -a log-install.txt
echo "G5"  | tee -a log-install.txt
echo "G6"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
echo "VPS AUTO REBOOT AT 00.00 WIB"  | tee -a log-install.txt
